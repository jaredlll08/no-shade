...
gradlePlugin {
    plugins {
        create("default") {
            ...
            implementationClass = "com.blamejared.noshade.gradle.DefaultPlugin"
        }
        create("loader") {
            id = "com.blamejared.noshade.loader"
            implementationClass = "com.blamejared.noshade.gradle.LoaderPlugin"
        }
    }
}
